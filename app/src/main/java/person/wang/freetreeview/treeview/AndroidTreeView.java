...
public class AndroidTreeView {
    ...
    public void addNodeSingle(TreeNode parent, final TreeNode nodeToAdd) {
        parent.addChild(nodeToAdd);
//        if (parent.isExpanded()) {
//            final TreeNode.BaseNodeViewHolder parentViewHolder = getViewHolderForNode(parent);
//            addNode(parentViewHolder.getNodeItemsView(), nodeToAdd);
//        }
    ...
    //添加本级里程碑
    public void addParentNode(TreeNode parent, final TreeNode nodeToAdd) {
        parent.getParent().addChild(nodeToAdd);
        if (parent.isExpanded()) {
            final TreeNode.BaseNodeViewHolder parentViewHolder = getViewHolderForNode(parent.getParent());
            addNode(parentViewHolder.getNodeItemsView(), nodeToAdd);
